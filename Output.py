...
class Output:
    ...
    def write_file(self):
        ...
        with open(f'output/output.csv', 'a') as file:
            ...
            #only for powerups
            file.write(f"{self.red_boost_time}, {self.red_boost_cubes}, {self.red_boost}")
            #{self.red_force_time}, {self.red_boost_cubes_used}, {self.red_force_cubes_used}, {self.red_lev_time}, {self.red_lev_used}, {self.blue_boost_time}, {self.blue_force_time}, {self.blue_boost_cubes_used}, {self.blue_force_cubes_used}, {self.blue_lev_time}, {self.blue_lev_used}")
